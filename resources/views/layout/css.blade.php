...
<link rel="stylesheet" type="text/css" href="{{asset('assets/plugin/datatable/datatables.min.css')}}">

<script type="text/javascript" charset="utf8" src="{{asset('assets/plugin/datatable/datatables.min.js')}}"></script>
